    ...
    public static void saveInventory(UUID uuid, Player p) {
        ...
        if(!file.exists()) {
            try {
                ...
                p.sendMessage(Main.pre + "§cEs ist ein Fehler beim erstellen deiner Inventar-Datei aufgetreten! Versuch es erneut.");
                return;
            }
        } else {
            ...
            try {
                ...
                p.sendMessage(Main.pre + "§cEs ist ein Fehler beim editieren deiner Inventar-Datei aufgetreten! Versuch es erneut.");
                return;
            }
        }
