...
public class Setarena2 implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (!p.hasPermission("Tom.setmine")) {
			...
			if (args[0].equalsIgnoreCase("1")) {
				...
				config.set("AA1.World", p.getWorld().getName());
				config.set("AA1.X", p.getLocation().getX());
				config.set("AA1.Y", p.getLocation().getY());
				config.set("AA1.Z", p.getLocation().getZ());
				config.set("AA1.Yaw", p.getLocation().getYaw());
				config.set("AA1.Pitch", p.getLocation().getPitch());
				...
				configA2.set("AA2.World", p.getWorld().getName());
				configA2.set("AA2.X", p.getLocation().getX());
				configA2.set("AA2.Y", p.getLocation().getY());
				configA2.set("AA2.Z", p.getLocation().getZ());
				configA2.set("AA2.Yaw", p.getLocation().getYaw());
				configA2.set("AA2.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
				...
				configA3.set("AA3.World", p.getWorld().getName());
				configA3.set("AA3.X", p.getLocation().getX());
				configA3.set("AA3.Y", p.getLocation().getY());
				configA3.set("AA3.Z", p.getLocation().getZ());
				configA3.set("AA3.Yaw", p.getLocation().getYaw());
				configA3.set("AA3.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
				p.sendMessage(Main.pre + "你3Du hast Mine 3 gesetzt!");

			} else if (args[0].equalsIgnoreCase("4")) {
				FileConfiguration configA4 = Main.getPlugin().getConfig();
				configA4.set("AA4.World", p.getWorld().getName());
				configA4.set("AA4.X", p.getLocation().getX());
				configA4.set("AA4.Y", p.getLocation().getY());
				configA4.set("AA4.Z", p.getLocation().getZ());
				configA4.set("AA4.Yaw", p.getLocation().getYaw());
				configA4.set("AA4.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
				p.sendMessage(Main.pre + "你3Du hast Mine 4 gesetzt!");

			} else if (args[0].equalsIgnoreCase("5")) {
				FileConfiguration configA5 = Main.getPlugin().getConfig();
				configA5.set("AA5.World", p.getWorld().getName());
				configA5.set("AA5.X", p.getLocation().getX());
				configA5.set("AA5.Y", p.getLocation().getY());
				configA5.set("AA5.Z", p.getLocation().getZ());
				configA5.set("AA5.Yaw", p.getLocation().getYaw());
				configA5.set("AA5.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
				p.sendMessage(Main.pre + "你3Du hast Mine 5 gesetzt!");

			} else if (args[0].equalsIgnoreCase("6")) {
				FileConfiguration configA6 = Main.getPlugin().getConfig();
				configA6.set("AA6.World", p.getWorld().getName());
				configA6.set("AA6.X", p.getLocation().getX());
				configA6.set("AA6.Y", p.getLocation().getY());
				configA6.set("AA6.Z", p.getLocation().getZ());
				configA6.set("AA6.Yaw", p.getLocation().getYaw());
				configA6.set("AA6.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
				p.sendMessage(Main.pre + "你3Du hast Mine 6 gesetzt!");

			} else if (args[0].equalsIgnoreCase("7")) {
				FileConfiguration configA7 = Main.getPlugin().getConfig();
				configA7.set("AA7.World", p.getWorld().getName());
				configA7.set("AA7.X", p.getLocation().getX());
				configA7.set("AA7.Y", p.getLocation().getY());
				configA7.set("AA7.Z", p.getLocation().getZ());
				configA7.set("AA7.Yaw", p.getLocation().getYaw());
				configA7.set("AA7.Pitch", p.getLocation().getPitch());
				Main.getPlugin().saveConfig();
