...
public class Shopzone1 implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            m.setTitle("§aVerkaufe die Items aus Zone 1");
           
            ItemStack stein = new ItemStack(Material.ROTTEN_FLESH);
            stein.setAmount(64);
           
            ItemStack ticket = new ItemStack(Material.PAPER);
            ItemMeta im = ticket.getItemMeta();
            im.setDisplayName("§a800$");
