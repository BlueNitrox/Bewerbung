...
public class MelonShop implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            m.setTitle("§aVerkaufe Melonen");
           
            ItemStack stein = new ItemStack(Material.MELON);
            stein.setAmount(64);
           
            ItemStack ticket = new ItemStack(Material.PAPER);
            ItemMeta im = ticket.getItemMeta();
            im.setDisplayName("§a64$");
