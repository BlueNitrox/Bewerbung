...
public class Shopzone3 implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            m.setTitle("§aVerkaufe die Items aus Zone 2");
           
            ItemStack stein = new ItemStack(Material.SPIDER_EYE);
            stein.setAmount(1);
           
            ItemStack ticket = new ItemStack(Material.PAPER);
            ItemMeta im = ticket.getItemMeta();
            im.setDisplayName("§a45$");
