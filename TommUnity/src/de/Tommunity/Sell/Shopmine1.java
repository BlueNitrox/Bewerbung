...
public class Shopmine1 implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            m.setTitle("§aVerkaufe die Erze aus Mine 1");
           
            ItemStack stein = new ItemStack(Material.COBBLESTONE);
            stein.setAmount(64);
           
            ItemStack ticket = new ItemStack(Material.PAPER);
            ItemMeta im = ticket.getItemMeta();
            im.setDisplayName("§a120$");
