...
public class setShop implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(!p.hasPermission("Tom.setspawn")) {
            ...
            config.set("Shop.World", p.getWorld().getName());
            config.set("Shop.X", p.getLocation().getX());
            config.set("Shop.Y", p.getLocation().getY());
            config.set("Shop.Z", p.getLocation().getZ());
            config.set("Shop.Yaw", p.getLocation().getYaw());
            config.set("Shop.Pitch", p.getLocation().getPitch());
